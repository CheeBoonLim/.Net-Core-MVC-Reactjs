...
class CreateNewCustomer extends React.Component {
    ...
    render() {
        ...
        return (
            <div>
                <button className="btn btn-primary" onClick={this.AddNewCustomer}><b>New Customer</b></button>
                                ...
                                <form id="form" >
                                    <fieldset id="SubmitForm">
                                        ...
                                        <div className="modal-footer">
                                            ...
                                            <button className="ui teal button" onClick={this.SaveCustomer}>create &nbsp; &nbsp;<i aria-hidden="true" className="check icon right floated"></i></button>
                                        </div>
                                    </fieldset>
                                </form>
                            </div>
